...
export const strings = {
  ...
  projects: {
    ...
    formIsMinorLabel:     "Proyecto Minor",
    formIsMinorHint:      "Marca esta opción para habilitar la sección de imputación de horas Minor en este proyecto.",
  ...
  vacations: {
    ...
    availabilityGroupProject:  "Proyecto",
