...
export const strings = {
  ...
  auth: {
    ...
    forgotPassword: {
      ...
      description:        "Introduce tu email y te enviaremos un código de recuperación a tus managers.",
      emailLabel:         "Email",
      emailPlaceholder:   "m@example.com",
      submitIdle:         "Solicitar código",
      submitLoading:      "Enviando...",
      hasAccount:         "¿Ya tienes cuenta?",
      loginLink:          "Iniciar sesión",
      successTitle:       "Código enviado a tus managers",
      successDescription: "Revisa tus notificaciones internas",
      successBody:        "Se ha generado un código de recuperación y se ha notificado a tus managers. Pídeles el código para restablecer tu contraseña.",
      recoveryLink:       "Introducir código de recuperación →",
    },
    recovery: {
      title:              "Restablecer contraseña",
      description:        "Introduce el código que te han dado tu manager y tu nueva contraseña.",
      ...
      submitIdle:         "Restablecer contraseña",
      ...
      successBody:        "Tu contraseña ha sido restablecida correctamente. Serás redirigido al inicio de sesión en unos segundos.",
      errorPasswordMatch: "Las contraseñas no coinciden.",
      errorMinLength:     "La contraseña debe tener al menos 6 caracteres.",
      errorInvalidCode:   "Código no válido o expirado.",
    },
    updatePassword: {
  ...
  notifications: {
    ...
    dashboardPendingTitle:  "Notificaciones pendientes",
    dashboardPendingDesc:   (n: number) => `${n} notificación${n !== 1 ? "es" : ""} sin leer`,
    dashboardEmpty:         "No tienes notificaciones pendientes.",
    dashboardMarkAllRead:   "Marcar todo como leído",
    dashboardFrom:          "De",
